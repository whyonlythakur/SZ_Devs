...
import { getDiscordLoginUrl } from '@/lib/dashboard-api';
...
export default function LoginPage() {
  ...
  const login = async () => {
    ...
    try {
      ...
      const url = await getDiscordLoginUrl(redirectUri);
