        ...
        <div className="mx-auto max-w-4xl">
          <div className="text-center">
            <div className="animate-fadeInUp mb-6 inline-block rounded-full border border-primary/30 bg-primary/5 px-4 py-1.5 text-sm text-primary transition-smooth">
              <span className="mr-2 font-mono font-bold opacity-80" aria-hidden="true">&gt;_</span>
              Snap-Z Development
            </div>
      ...
      <section className="px-4 py-20 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-6xl">
          <div className="mb-12 animate-fadeInUp">
            <h2 className="mb-3 text-3xl font-bold text-foreground sm:text-4xl">Featured Code Snippets</h2>
            <p className="text-lg text-muted-foreground">Handpicked tutorials and code examples to get you started</p>
          </div>
        ...
        <div className="mx-auto max-w-6xl">
          <div className="mb-8 grid gap-8 sm:grid-cols-3">
            <div>
              ...
              <p className="text-sm text-muted-foreground">Creating quality web development tutorials and code snippets.</p>
            </div>

            <div>
              <h4 className="mb-4 font-semibold text-foreground">Quick Links</h4>
              <ul className="space-y-2 text-sm">
                <li><Link href="/codes" className="text-muted-foreground transition-colors hover:text-primary">Code Snippets</Link></li>
            ...
            <div>
              ...
              <div className="flex gap-4">
                <a href={YOUTUBE_URL} target="_blank" rel="noopener noreferrer" className="text-muted-foreground transition-colors hover:text-primary" aria-label="YouTube">
                  <Youtube className="h-5 w-5" />
                </a>
                <a href={YOUTUBE_URL} target="_blank" rel="noopener noreferrer" className="text-muted-foreground transition-colors hover:text-primary" aria-label="GitHub">
                  <Github className="h-5 w-5" />
                </a>
                <a href={YOUTUBE_URL} target="_blank" rel="noopener noreferrer" className="text-muted-foreground transition-colors hover:text-primary" aria-label="Twitter">
