    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="border-b border-border px-4 py-12 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-4xl">
          <h1 className="mb-4 text-4xl font-bold text-foreground sm:text-5xl">About Snap-Z Development</h1>
          <p className="text-lg text-muted-foreground">Learn more about our mission to create quality web development content</p>
        </div>
      </section>
          ...
          <section>
            ...
            <div className="rounded-lg border border-border bg-card p-8">
              ...
              <div className="mt-6 flex gap-4">
                <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 rounded-lg bg-primary/10 px-4 py-2 text-primary transition-colors hover:bg-primary/20" aria-label="Twitter">
                  <Twitter className="h-4 w-4" /> Twitter
                </a>
                <a href="https://github.com" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 rounded-lg bg-primary/10 px-4 py-2 text-primary transition-colors hover:bg-primary/20" aria-label="GitHub">
                  <Github className="h-4 w-4" /> GitHub
                </a>
                <a href="https://youtube.com" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 rounded-lg bg-primary/10 px-4 py-2 text-primary transition-colors hover:bg-primary/20" aria-label="YouTube">
