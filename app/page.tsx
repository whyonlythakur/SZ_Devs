    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="relative overflow-hidden px-4 py-20 sm:py-32 sm:px-6 lg:px-8">
        <div className="absolute inset-0 -z-10">
          ...
          <div className="absolute -left-1/2 top-1/4 h-96 w-96 rounded-full bg-primary/10 blur-3xl animate-pulse-glow" />
          <div className="absolute -right-1/2 top-1/3 h-96 w-96 rounded-full bg-accent/10 blur-3xl animate-pulse-glow" style={{ animationDelay: '1s' }} />
        </div>
